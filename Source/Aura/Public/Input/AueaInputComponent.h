...
#include "AueaInputConfig.h"
#include "AueaInputComponent.generated.h"

/**
 * 
 */
UCLASS()
class AURA_API UAueaInputComponent : public UEnhancedInputComponent
{
	GENERATED_BODY()
...
public:
	...
	void BindAbilityActions(
		const UAueaInputConfig* InputConfig, UserClass* Object,
